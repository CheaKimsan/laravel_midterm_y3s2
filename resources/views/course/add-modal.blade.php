<div id="courseModal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50">
    <div class="bg-slate-800 w-full max-w-xl rounded-xl shadow-lg p-6 text-white">

        <h2 class="text-xl mb-4">Add Course</h2>

        <form action="{{ route('course.store') }}" method="POST" class="space-y-4">
            @csrf

            @include('course.form-fields')
